...
class AuditSettings(AppSettings):
    ...
    audit_db_name: str = "converse_audit"
    ...
    def database_url(self) -> str:
        return f"postgresql+asyncpg://{self.postgres_user}:{self.postgres_password}@{self.postgres_host}:{self.postgres_port}/{self.audit_db_name}"
